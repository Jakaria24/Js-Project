...
let kiloToMeter = kilometerToMeter(10);  // 5 is testing input you can input here any number to test this.
...
let total = budgetCalculator(4, 5, 6); // In this line watch value = 4 , phone value = 5 , laptop value = 6
console.log(total);
...
let output = megaFriend(["Sujon", "Alamin", "Sumon", "Lelin"]); // Testing input
console.log(output);
